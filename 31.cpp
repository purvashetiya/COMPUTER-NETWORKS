...
print(" - Subtract 2 because Network 0 is reserved and Network 127 is reserved for
Loopback.")
print("No of Hosts: 2^24 - 2 = 16,777,214")
print("Reason:")
print(" - 24 bits are available for host IDs.")

print(" - Subtract 2 because one address is the Network Address and one is the
Broadcast Address.")
...
print(" - Any packet sent to a 127.x.x.x address is returned to the same computer
...
print(" - Remaining 6 bits in the first octet + 8 bits in the second octet = 14 network
bits.")
...
print(" - Remaining 5 bits in the first octet + 8 bits in the second octet + 8 bits in the
third octet = 21 network bits.")
...
print("No of Hosts: Not Applicable")
print("Reason:")
print(" - Class E addresses are reserved for experimental and research purposes.")
